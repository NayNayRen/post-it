...
Just a practice application using Laravel. There's CRUD (create, read, update, delete) functionality for users.

Once registered and signed in, you have CRUD (create, read, update, delete) functionality with posts of your own.

This app isn't hosted anywhere, only the source code here is viewable.
